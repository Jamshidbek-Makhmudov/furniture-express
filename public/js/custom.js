...
$(document).ready(function () {
	$('.datatable_toggle').on('click', 'i[data-toggle]', function () {
		var $this = $(this),
...
/*개인정보정책*/
// $(document).ready(function () {
// 	if (config_vw_name == 'N') $('.cfg_vw_name').remove();
// 	if (config_vw_tel == 'N') $('.cfg_vw_tel').remove();
// 	if (config_vw_email == 'N') $('.cfg_vw_email').remove();
// 	if (config_vw_company == 'N') $('.cfg_vw_company').remove();
// 	if (config_vw_manager == 'N') $('.cfg_vw_manager').remove();
// });
...
function checkBlankData(id) {
	...
	if (str == '') {
		msg = tag_name == 'SELECT' ? qq230[lang_code] : qq231[lang_code];
